...
class IGJEPA_V2(nn.Module):
    ...
    def subgraph_mask(self, ei, N):
        """BFS-based subgraph masking: removes nodes AND their edges."""
    ...
    def forward(self, batch):
        ...
        cm = ctx_emb - ctx_emb.mean(0)
        cov = (cm.T @ cm) / max(Nc-1, 1)
...
def main():
    ...
    sig_path = f"/home/ud3d4/Desktop/Projects/NIPS 26/signals/gap_close_{args.dataset}.json"
